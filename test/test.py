...
async def test_priority_encoder(dut):
    ...
    # Expected C[7:0] = 0000 1101 (13 in decimal)
    dut.ui_in.value = 0b00101010
    dut.uio_in.value = 0b11110001
    await ClockCycles(dut.clk, 1)
    assert dut.uo_out.value.integer == 0b00001101, "Test 1 Failed!"

    # Test Case 2: In[15:0] = 0000 0000 0000 0001 
    # Expected C[7:0] = 0000 0000
    dut.ui_in.value = 0b00000000
    dut.uio_in.value = 0b00000001
    await ClockCycles(dut.clk, 1)
    assert dut.uo_out.value.integer == 0b00000000, "Test 2 Failed!"

    # Test Case 3: In[15:0] = 0000 0000 0000 0000 
    # Expected C[7:0] = 1111 0000
    dut.ui_in.value = 0b00000000
    dut.uio_in.value = 0b00000000
    await ClockCycles(dut.clk, 1)
    assert dut.uo_out.value.integer == 0b11110000, "Test 3 Failed!"

    # Extra Test Case: In[15:0] = 1100 0000 0000 0000 
    # Expected C[7:0] = 0000 1111 (15 in decimal)
